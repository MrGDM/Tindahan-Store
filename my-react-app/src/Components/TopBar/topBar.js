...
const Topbar = () => {
    ...
    return (
        <div className="topbar">
                ...
                {dropDown && (<div className='drop-down-admin'>
                    <div>
                        ...
                        <div className='selection-div' style={{ backgroundColor: sm.cp ? '#444444' : '#FBFBFB', cursor: 'pointer' }} onMouseEnter={() => setSm({ mo: false, cp: true })} onMouseLeave={leaving}>
                            <FaUsers color={sm.cp ? '#FFFFFF' : '#626262'} size={28} style={{ marginLeft: 25 }} />
                            <p style={{ color: sm.cp ? '#FFFFFF' : '#626262', fontWeight: 500, fontSize: 16, marginLeft: 20 }}>Cashiers</p>
                        </div>
            ...
            <p style={{ fontSize: 23, color: 'white' }}>MAIN DASHBOARD</p>
            <div className="ad">
